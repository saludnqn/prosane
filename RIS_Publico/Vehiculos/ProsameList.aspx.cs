...
namespace Web.ProsameList
{
    public partial class VehiculosList : System.Web.UI.Page
    {
        ...
        private void cargarCombos()
        {
            ...
            ddlEfector.DataSource = SPs.Cargarcomboefectores().GetDataSet().Tables[0]; 
            ddlEfector.DataBind();
            ddlEfector.Items.Insert(0, new ListItem("Todas", "0"));

            // -------------------------------------------------------------------------------

            ddlEstablecimiento.DataSource = SPs.Cargarcomboefectores().GetDataSet().Tables[0]; 
            ddlEstablecimiento.DataBind();
            ddlEstablecimiento.Items.Insert(0, new ListItem("Todas", "0"));
