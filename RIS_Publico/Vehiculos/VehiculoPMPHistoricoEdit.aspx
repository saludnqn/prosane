<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VehiculoPMPHistoricoEdit.aspx.cs" Inherits="Web.Vehiculos.VehiculoPMPHistoricoEdit" MasterPageFile="~/Site1.Master" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
  ...
  <script type="text/javascript">
	...
	$(function() {
		$("#<%=txtFechaPMP.ClientID %>").datepicker({
			showOn: 'button',
                                            ...
                                            <table style="width:100%;">
                                                <tr>
                                                    <td style="width: 171px">
                                                        Fecha</td>
                                                    <td>
                                                        <asp:TextBox ID="txtFechaPMP" runat="server" maxlength="10" 
                                                ...
                                                <tr>
                                                    <td style="width: 171px">
                                                        Kilometraje</td>
                                                    <td>
                                                        <asp:TextBox ID="txtKilometraje" runat="server" Width="69px" TabIndex="1"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                </table>
                        </td>
