...
{
	/// <summary>
	/// Strongly-typed collection for the AprActividad class.
	/// </summary>
    [Serializable]
	public partial class AprActividadCollection : ActiveList<AprActividad, AprActividadCollection>
	{	   
		public AprActividadCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprActividadCollection</returns>
		public AprActividadCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprActividad o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_Actividad table.
	/// </summary>
	[Serializable]
	public partial class AprActividad : ActiveRecord<AprActividad>, IActiveRecord
	{
		...
		public AprActividad(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprActividad(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprActividad(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_Actividad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				colvarIdActividad.AutoIncrement = true;
				colvarIdActividad.IsNullable = false;
				colvarIdActividad.IsPrimaryKey = true;
				colvarIdActividad.IsForeignKey = false;
				colvarIdActividad.IsReadOnly = false;
				colvarIdActividad.DefaultSetting = @"";
				colvarIdActividad.ForeignKeyTableName = "";
				...
				DataService.Providers["RisProvider"].AddSchema("APR_Actividad",schema);
			}
		}
		#endregion
		...
		public DalRis.AprIntervencionProfesionalCollection AprIntervencionProfesionalRecords()
		{
			...
			{
				colAprIntervencionProfesionalRecords = new DalRis.AprIntervencionProfesionalCollection().Where(AprIntervencionProfesional.Columns.IdActividad, IdActividad).Load();
		...
		void colAprIntervencionProfesionalRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colAprIntervencionProfesionalRecords[e.NewIndex].IdActividad = IdActividad;
				colAprIntervencionProfesionalRecords.ListChanged += new ListChangedEventHandler(colAprIntervencionProfesionalRecords_ListChanged);
            }
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varIdActividad,string varNombre,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprActividad item = new AprActividad();
