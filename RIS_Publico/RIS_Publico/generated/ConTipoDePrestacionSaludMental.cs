...
namespace DalRis
{
	...
	public partial class ConTipoDePrestacionSaludMental : ActiveRecord<ConTipoDePrestacionSaludMental>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CON_TipoDePrestacionSaludMental", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("CON_TipoDePrestacionSaludMental",schema);
			}
		}
		#endregion
