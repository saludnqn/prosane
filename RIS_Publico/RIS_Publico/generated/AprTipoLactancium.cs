...
{
	/// <summary>
	/// Strongly-typed collection for the AprTipoLactancium class.
	/// </summary>
    [Serializable]
	public partial class AprTipoLactanciumCollection : ActiveList<AprTipoLactancium, AprTipoLactanciumCollection>
	{	   
		public AprTipoLactanciumCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprTipoLactanciumCollection</returns>
		public AprTipoLactanciumCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprTipoLactancium o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_TipoLactancia table.
	/// </summary>
	[Serializable]
	public partial class AprTipoLactancium : ActiveRecord<AprTipoLactancium>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprTipoLactancium()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprTipoLactancium(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprTipoLactancium(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprTipoLactancium(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_TipoLactancia", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				colvarIdTipoLactancia.AutoIncrement = true;
				colvarIdTipoLactancia.IsNullable = false;
				colvarIdTipoLactancia.IsPrimaryKey = true;
				colvarIdTipoLactancia.IsForeignKey = false;
				colvarIdTipoLactancia.IsReadOnly = false;
				colvarIdTipoLactancia.DefaultSetting = @"";
				colvarIdTipoLactancia.ForeignKeyTableName = "";
				...
				DataService.Providers["RisProvider"].AddSchema("APR_TipoLactancia",schema);
			}
		}
		#endregion
		...
		void colAprControlNiñoSanoConsultorioRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        ...
		        colAprControlNiñoSanoConsultorioRecords[e.NewIndex].IdTipoLactancia = IdTipoLactancia;
				colAprControlNiñoSanoConsultorioRecords.ListChanged += new ListChangedEventHandler(colAprControlNiñoSanoConsultorioRecords_ListChanged);
            }
		}
		#endregion
		...
		{
			AprTipoLactancium item = new AprTipoLactancium();
		...
		/// </summary>
		public static void Update(int varIdTipoLactancia,string varNombre,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprTipoLactancium item = new AprTipoLactancium();
        ...
        public void SetPKValues()
        {
                if (colAprControlNiñoSanoConsultorioRecords != null)
                {
                    ...
                    {
                        if (item.IdTipoLactancia != IdTipoLactancia)
                        {
