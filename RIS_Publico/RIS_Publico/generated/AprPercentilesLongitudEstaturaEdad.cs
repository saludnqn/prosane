...
namespace DalRis
{
	...
	public partial class AprPercentilesLongitudEstaturaEdad : ActiveRecord<AprPercentilesLongitudEstaturaEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesLongitudEstaturaEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_PercentilesLongitudEstaturaEdad",schema);
			}
		}
		#endregion
