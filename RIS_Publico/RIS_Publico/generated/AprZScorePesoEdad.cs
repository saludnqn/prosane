...
namespace DalRis
{
	...
	public partial class AprZScorePesoEdad : ActiveRecord<AprZScorePesoEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePesoEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ZScorePesoEdad",schema);
			}
		}
		#endregion
