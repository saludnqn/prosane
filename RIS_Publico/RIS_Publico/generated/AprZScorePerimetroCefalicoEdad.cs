...
namespace DalRis
{
	...
	public partial class AprZScorePerimetroCefalicoEdad : ActiveRecord<AprZScorePerimetroCefalicoEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePerimetroCefalicoEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ZScorePerimetroCefalicoEdad",schema);
			}
		}
		#endregion
