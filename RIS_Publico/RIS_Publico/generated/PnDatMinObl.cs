...
{
	/// <summary>
	/// Strongly-typed collection for the PnDatMinObl class.
	/// </summary>
    [Serializable]
	public partial class PnDatMinOblCollection : ActiveList<PnDatMinObl, PnDatMinOblCollection>
	{	   
		public PnDatMinOblCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PnDatMinOblCollection</returns>
		public PnDatMinOblCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PnDatMinObl o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PN_dat_min_obl table.
	/// </summary>
	[Serializable]
	public partial class PnDatMinObl : ActiveRecord<PnDatMinObl>, IActiveRecord
	{
		...
		public PnDatMinObl(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PnDatMinObl(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PnDatMinObl(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_dat_min_obl", TableType.Table, DataService.GetInstance("RisProvider"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarIdDatMinObl = new TableSchema.TableColumn(schema);
				colvarIdDatMinObl.ColumnName = "id_dat_min_obl";
				colvarIdDatMinObl.DataType = DbType.Int32;
				colvarIdDatMinObl.MaxLength = 0;
				colvarIdDatMinObl.AutoIncrement = true;
				colvarIdDatMinObl.IsNullable = false;
				colvarIdDatMinObl.IsPrimaryKey = true;
				colvarIdDatMinObl.IsForeignKey = false;
				colvarIdDatMinObl.IsReadOnly = false;
				colvarIdDatMinObl.DefaultSetting = @"";
				colvarIdDatMinObl.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIdDatMinObl);
				...
				TableSchema.TableColumn colvarLblText = new TableSchema.TableColumn(schema);
				colvarLblText.ColumnName = "lbl_text";
				colvarLblText.DataType = DbType.AnsiString;
				colvarLblText.MaxLength = -1;
				colvarLblText.AutoIncrement = false;
				colvarLblText.IsNullable = false;
				colvarLblText.IsPrimaryKey = false;
				colvarLblText.IsForeignKey = false;
				colvarLblText.IsReadOnly = false;
				colvarLblText.DefaultSetting = @"";
				colvarLblText.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLblText);
				...
				DataService.Providers["RisProvider"].AddSchema("PN_dat_min_obl",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("IdDatMinObl")]
		[Bindable(true)]
		public int IdDatMinObl 
		{
			get { return GetColumnValue<int>(Columns.IdDatMinObl); }
			set { SetColumnValue(Columns.IdDatMinObl, value); }
		}
		...
		[XmlAttribute("LblText")]
		[Bindable(true)]
		public string LblText 
		{
			get { return GetColumnValue<string>(Columns.LblText); }
			set { SetColumnValue(Columns.LblText, value); }
		}
		...
		/// </summary>
		public static void Insert(string varTextoBoton,string varLblText,string varPaginaDestino,string varParamPaginaDestino,string varObligaEfector,string varPracticaVincula,string varObjPrestacionVincula,string varDiagnostico,string varGrupoEtareo,string varSexo)
		{
			PnDatMinObl item = new PnDatMinObl();
			
			item.TextoBoton = varTextoBoton;
			
			item.LblText = varLblText;
		...
		/// </summary>
		public static void Update(int varIdDatMinObl,string varTextoBoton,string varLblText,string varPaginaDestino,string varParamPaginaDestino,string varObligaEfector,string varPracticaVincula,string varObjPrestacionVincula,string varDiagnostico,string varGrupoEtareo,string varSexo)
		{
			PnDatMinObl item = new PnDatMinObl();
			
				item.IdDatMinObl = varIdDatMinObl;
        ...
        public static TableSchema.TableColumn IdDatMinOblColumn
        {
        ...
        public static TableSchema.TableColumn LblTextColumn
        {
		...
		{
			 public static string IdDatMinObl = @"id_dat_min_obl";
			 public static string TextoBoton = @"texto_boton";
			 public static string LblText = @"lbl_text";
