...
{
	/// <summary>
	/// Strongly-typed collection for the AprZScoreIMCEdad class.
	/// </summary>
    [Serializable]
	public partial class AprZScoreIMCEdadCollection : ActiveList<AprZScoreIMCEdad, AprZScoreIMCEdadCollection>
	{	   
		public AprZScoreIMCEdadCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprZScoreIMCEdadCollection</returns>
		public AprZScoreIMCEdadCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprZScoreIMCEdad o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_ZScoreIMCEdad table.
	/// </summary>
	[Serializable]
	public partial class AprZScoreIMCEdad : ActiveRecord<AprZScoreIMCEdad>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprZScoreIMCEdad()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprZScoreIMCEdad(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprZScoreIMCEdad(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprZScoreIMCEdad(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScoreIMCEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ZScoreIMCEdad",schema);
			}
		}
		#endregion
