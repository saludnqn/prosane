...
namespace DalRis{
    /// <summary>
    /// Strongly-typed collection for the FacOrdene class.
    /// </summary>
    [Serializable]
    public partial class FacOrdeneCollection : ReadOnlyList<FacOrdene, FacOrdeneCollection>
    {        
        public FacOrdeneCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the FAC_Ordenes view.
    /// </summary>
    [Serializable]
    public partial class FacOrdene : ReadOnlyRecord<FacOrdene>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("FAC_Ordenes", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("FAC_Ordenes",schema);
            }
        }
        #endregion
        ...
        public FacOrdene(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public FacOrdene(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public FacOrdene(string columnName, object columnValue)
        {
            SetSQLProps();
