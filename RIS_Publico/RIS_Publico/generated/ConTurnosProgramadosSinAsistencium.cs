...
namespace DalRis{
    ...
    public partial class ConTurnosProgramadosSinAsistencium : ReadOnlyRecord<ConTurnosProgramadosSinAsistencium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_TurnosProgramadosSinAsistencia", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_TurnosProgramadosSinAsistencia",schema);
            }
        }
        #endregion
