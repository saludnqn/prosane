...
namespace DalRis{
    ...
    public partial class PnCantidadEmb : ReadOnlyRecord<PnCantidadEmb>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("PN_CantidadEmb", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("PN_CantidadEmb",schema);
            }
        }
        #endregion
