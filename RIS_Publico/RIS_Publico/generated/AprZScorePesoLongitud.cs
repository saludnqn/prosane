...
{
	/// <summary>
	/// Strongly-typed collection for the AprZScorePesoLongitud class.
	/// </summary>
    [Serializable]
	public partial class AprZScorePesoLongitudCollection : ActiveList<AprZScorePesoLongitud, AprZScorePesoLongitudCollection>
	{	   
		public AprZScorePesoLongitudCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprZScorePesoLongitudCollection</returns>
		public AprZScorePesoLongitudCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprZScorePesoLongitud o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_ZScorePesoLongitud table.
	/// </summary>
	[Serializable]
	public partial class AprZScorePesoLongitud : ActiveRecord<AprZScorePesoLongitud>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprZScorePesoLongitud()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprZScorePesoLongitud(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprZScorePesoLongitud(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprZScorePesoLongitud(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePesoLongitud", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ZScorePesoLongitud",schema);
			}
		}
		#endregion
