...
namespace DalRis{
    ...
    public partial class ConTurnosDelDiaConAsistencium : ReadOnlyRecord<ConTurnosDelDiaConAsistencium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_TurnosDelDiaConAsistencia", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_TurnosDelDiaConAsistencia",schema);
            }
        }
        #endregion
