...
namespace DalRis{
    ...
    public partial class ConTurnosDelDiaSinAsistencium : ReadOnlyRecord<ConTurnosDelDiaSinAsistencium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_TurnosDelDiaSinAsistencia", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_TurnosDelDiaSinAsistencia",schema);
            }
        }
        #endregion
