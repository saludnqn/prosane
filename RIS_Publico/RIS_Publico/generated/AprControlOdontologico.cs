...
{
	/// <summary>
	/// Strongly-typed collection for the AprControlOdontologico class.
	/// </summary>
    [Serializable]
	public partial class AprControlOdontologicoCollection : ActiveList<AprControlOdontologico, AprControlOdontologicoCollection>
	{	   
		public AprControlOdontologicoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprControlOdontologicoCollection</returns>
		public AprControlOdontologicoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprControlOdontologico o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_ControlOdontologico table.
	/// </summary>
	[Serializable]
	public partial class AprControlOdontologico : ActiveRecord<AprControlOdontologico>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprControlOdontologico()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprControlOdontologico(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprControlOdontologico(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprControlOdontologico(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ControlOdontologico", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ControlOdontologico",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a SysEfector ActiveRecord object related to this AprControlOdontologico
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a SysProfesional ActiveRecord object related to this AprControlOdontologico
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int varIdPaciente,int varIdEfector,DateTime? varFecha,string varMotivo,string varDescripcion,int varIdProfesional,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
		...
		/// </summary>
		public static void Update(int varIdControlOdontologico,int varIdPaciente,int varIdEfector,DateTime? varFecha,string varMotivo,string varDescripcion,int varIdProfesional,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprControlOdontologico item = new AprControlOdontologico();
