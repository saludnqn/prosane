...
namespace DalRis
{
	...
	public partial class AprAlimentacionRecienNacido : ActiveRecord<AprAlimentacionRecienNacido>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_AlimentacionRecienNacido", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_AlimentacionRecienNacido",schema);
			}
		}
		#endregion
