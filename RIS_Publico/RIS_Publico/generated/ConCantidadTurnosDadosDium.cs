...
namespace DalRis{
    /// <summary>
    /// Strongly-typed collection for the ConCantidadTurnosDadosDium class.
    /// </summary>
    [Serializable]
    public partial class ConCantidadTurnosDadosDiumCollection : ReadOnlyList<ConCantidadTurnosDadosDium, ConCantidadTurnosDadosDiumCollection>
    {        
        public ConCantidadTurnosDadosDiumCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the CON_CantidadTurnosDadosDia view.
    /// </summary>
    [Serializable]
    public partial class ConCantidadTurnosDadosDium : ReadOnlyRecord<ConCantidadTurnosDadosDium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosDadosDia", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_CantidadTurnosDadosDia",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ConCantidadTurnosDadosDium()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ConCantidadTurnosDadosDium(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ConCantidadTurnosDadosDium(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ConCantidadTurnosDadosDium(string columnName, object columnValue)
        {
            SetSQLProps();
