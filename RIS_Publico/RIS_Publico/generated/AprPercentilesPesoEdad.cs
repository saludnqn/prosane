...
{
	/// <summary>
	/// Strongly-typed collection for the AprPercentilesPesoEdad class.
	/// </summary>
    [Serializable]
	public partial class AprPercentilesPesoEdadCollection : ActiveList<AprPercentilesPesoEdad, AprPercentilesPesoEdadCollection>
	{	   
		public AprPercentilesPesoEdadCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprPercentilesPesoEdadCollection</returns>
		public AprPercentilesPesoEdadCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprPercentilesPesoEdad o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_PercentilesPesoEdad table.
	/// </summary>
	[Serializable]
	public partial class AprPercentilesPesoEdad : ActiveRecord<AprPercentilesPesoEdad>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprPercentilesPesoEdad()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprPercentilesPesoEdad(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprPercentilesPesoEdad(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprPercentilesPesoEdad(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesPesoEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_PercentilesPesoEdad",schema);
			}
		}
		#endregion
