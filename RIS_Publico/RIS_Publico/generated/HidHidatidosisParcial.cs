...
{
	/// <summary>
	/// Strongly-typed collection for the HidHidatidosisParcial class.
	/// </summary>
    [Serializable]
	public partial class HidHidatidosisParcialCollection : ActiveList<HidHidatidosisParcial, HidHidatidosisParcialCollection>
	{	   
		public HidHidatidosisParcialCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>HidHidatidosisParcialCollection</returns>
		public HidHidatidosisParcialCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                HidHidatidosisParcial o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Hid_HidatidosisParcial table.
	/// </summary>
	[Serializable]
	public partial class HidHidatidosisParcial : ActiveRecord<HidHidatidosisParcial>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public HidHidatidosisParcial()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public HidHidatidosisParcial(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public HidHidatidosisParcial(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public HidHidatidosisParcial(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Hid_HidatidosisParcial", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				TableSchema.TableColumn colvarCargado = new TableSchema.TableColumn(schema);
				colvarCargado.ColumnName = "cargado";
				colvarCargado.DataType = DbType.Boolean;
				colvarCargado.MaxLength = 0;
				colvarCargado.AutoIncrement = false;
				colvarCargado.IsNullable = false;
				colvarCargado.IsPrimaryKey = false;
				colvarCargado.IsForeignKey = false;
				colvarCargado.IsReadOnly = false;
				
						colvarCargado.DefaultSetting = @"((0))";
				colvarCargado.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCargado);
				...
				DataService.Providers["RisProvider"].AddSchema("Hid_HidatidosisParcial",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("Cargado")]
		[Bindable(true)]
		public bool Cargado 
		{
			get { return GetColumnValue<bool>(Columns.Cargado); }
			set { SetColumnValue(Columns.Cargado, value); }
		}
        ...
        public static TableSchema.TableColumn CargadoColumn
        {
