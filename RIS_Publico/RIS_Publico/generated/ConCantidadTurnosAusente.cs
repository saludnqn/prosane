...
namespace DalRis{
    /// <summary>
    /// Strongly-typed collection for the ConCantidadTurnosAusente class.
    /// </summary>
    [Serializable]
    public partial class ConCantidadTurnosAusenteCollection : ReadOnlyList<ConCantidadTurnosAusente, ConCantidadTurnosAusenteCollection>
    {        
        public ConCantidadTurnosAusenteCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the CON_CantidadTurnosAusentes view.
    /// </summary>
    [Serializable]
    public partial class ConCantidadTurnosAusente : ReadOnlyRecord<ConCantidadTurnosAusente>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosAusentes", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_CantidadTurnosAusentes",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ConCantidadTurnosAusente()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ConCantidadTurnosAusente(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ConCantidadTurnosAusente(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ConCantidadTurnosAusente(string columnName, object columnValue)
        {
            SetSQLProps();
