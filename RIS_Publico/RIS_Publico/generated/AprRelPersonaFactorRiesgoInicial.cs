...
{
	/// <summary>
	/// Strongly-typed collection for the AprRelPersonaFactorRiesgoInicial class.
	/// </summary>
    [Serializable]
	public partial class AprRelPersonaFactorRiesgoInicialCollection : ActiveList<AprRelPersonaFactorRiesgoInicial, AprRelPersonaFactorRiesgoInicialCollection>
	{	   
		public AprRelPersonaFactorRiesgoInicialCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprRelPersonaFactorRiesgoInicialCollection</returns>
		public AprRelPersonaFactorRiesgoInicialCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprRelPersonaFactorRiesgoInicial o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_RelPersonaFactorRiesgoInicial table.
	/// </summary>
	[Serializable]
	public partial class AprRelPersonaFactorRiesgoInicial : ActiveRecord<AprRelPersonaFactorRiesgoInicial>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprRelPersonaFactorRiesgoInicial()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprRelPersonaFactorRiesgoInicial(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprRelPersonaFactorRiesgoInicial(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprRelPersonaFactorRiesgoInicial(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_RelPersonaFactorRiesgoInicial", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				TableSchema.TableColumn colvarIdPersona = new TableSchema.TableColumn(schema);
				colvarIdPersona.ColumnName = "idPersona";
				colvarIdPersona.DataType = DbType.Int32;
				colvarIdPersona.MaxLength = 0;
				colvarIdPersona.AutoIncrement = false;
				colvarIdPersona.IsNullable = false;
				colvarIdPersona.IsPrimaryKey = false;
				colvarIdPersona.IsForeignKey = false;
				colvarIdPersona.IsReadOnly = false;
				colvarIdPersona.DefaultSetting = @"";
				colvarIdPersona.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIdPersona);
				...
				DataService.Providers["RisProvider"].AddSchema("APR_RelPersonaFactorRiesgoInicial",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("IdPersona")]
		[Bindable(true)]
		public int IdPersona 
		{
			get { return GetColumnValue<int>(Columns.IdPersona); }
			set { SetColumnValue(Columns.IdPersona, value); }
		}
		...
		/// <summary>
		/// Returns a AprFactorRiesgo ActiveRecord object related to this AprRelPersonaFactorRiesgoInicial
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int varIdPersona,int varIdFactorRiesgo,DateTime? varFechaHora,string varObservacion,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprRelPersonaFactorRiesgoInicial item = new AprRelPersonaFactorRiesgoInicial();
			
			item.IdPersona = varIdPersona;
		...
		/// </summary>
		public static void Update(int varIdRelacion,int varIdPersona,int varIdFactorRiesgo,DateTime? varFechaHora,string varObservacion,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprRelPersonaFactorRiesgoInicial item = new AprRelPersonaFactorRiesgoInicial();
        ...
        public static TableSchema.TableColumn IdPersonaColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string IdPersona = @"idPersona";
