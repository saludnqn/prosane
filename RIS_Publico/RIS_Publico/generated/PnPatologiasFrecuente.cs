...
{
	/// <summary>
	/// Strongly-typed collection for the PnPatologiasFrecuente class.
	/// </summary>
    [Serializable]
	public partial class PnPatologiasFrecuenteCollection : ActiveList<PnPatologiasFrecuente, PnPatologiasFrecuenteCollection>
	{	   
		public PnPatologiasFrecuenteCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PnPatologiasFrecuenteCollection</returns>
		public PnPatologiasFrecuenteCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PnPatologiasFrecuente o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PN_patologias_frecuentes table.
	/// </summary>
	[Serializable]
	public partial class PnPatologiasFrecuente : ActiveRecord<PnPatologiasFrecuente>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public PnPatologiasFrecuente()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public PnPatologiasFrecuente(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PnPatologiasFrecuente(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PnPatologiasFrecuente(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_patologias_frecuentes", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				TableSchema.TableColumn colvarIdPatologiasFrecuentes = new TableSchema.TableColumn(schema);
				colvarIdPatologiasFrecuentes.ColumnName = "id_patologias_frecuentes";
				colvarIdPatologiasFrecuentes.DataType = DbType.Int32;
				colvarIdPatologiasFrecuentes.MaxLength = 0;
				colvarIdPatologiasFrecuentes.AutoIncrement = true;
				colvarIdPatologiasFrecuentes.IsNullable = false;
				colvarIdPatologiasFrecuentes.IsPrimaryKey = true;
				colvarIdPatologiasFrecuentes.IsForeignKey = false;
				colvarIdPatologiasFrecuentes.IsReadOnly = false;
				colvarIdPatologiasFrecuentes.DefaultSetting = @"";
				colvarIdPatologiasFrecuentes.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIdPatologiasFrecuentes);
				...
				DataService.Providers["RisProvider"].AddSchema("PN_patologias_frecuentes",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("IdPatologiasFrecuentes")]
		[Bindable(true)]
		public int IdPatologiasFrecuentes 
		{
			get { return GetColumnValue<int>(Columns.IdPatologiasFrecuentes); }
			set { SetColumnValue(Columns.IdPatologiasFrecuentes, value); }
		}
		...
		/// </summary>
		public static void Update(string varCodigo,string varDescripcion,int? varIdNomencladorDetalle,string varNeo,string varCeroacinco,string varSeisanueve,string varAdol,string varAdulto,string varColor,int varIdPatologiasFrecuentes,string varF,string varGrupoPatologias,string varM)
		{
			PnPatologiasFrecuente item = new PnPatologiasFrecuente();
				...
				item.IdPatologiasFrecuentes = varIdPatologiasFrecuentes;
        ...
        public static TableSchema.TableColumn IdPatologiasFrecuentesColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string IdPatologiasFrecuentes = @"id_patologias_frecuentes";
