...
namespace DalRis{
    public partial class SPs{
        ...
        /// </summary>
        public static StoredProcedure AprAlertaCtrolPerinatal(int? idPaciente)
        {
        ...
        /// </summary>
        public static StoredProcedure AprGetPacientesConHCP(int? numerodoc)
        {
        ...
        /// </summary>
        public static StoredProcedure AprScoreBPN(int? idPaciente, DateTime? fechacontrol)
        {
        ...
        /// </summary>
        public static StoredProcedure PsmBuscarPacExistente(int? NumeroDocumento)
        {
