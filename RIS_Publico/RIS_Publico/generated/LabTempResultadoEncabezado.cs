...
{
	/// <summary>
	/// Strongly-typed collection for the LabTempResultadoEncabezado class.
	/// </summary>
    [Serializable]
	public partial class LabTempResultadoEncabezadoCollection : ActiveList<LabTempResultadoEncabezado, LabTempResultadoEncabezadoCollection>
	{	   
        ...
        /// </summary>
        /// <returns>LabTempResultadoEncabezadoCollection</returns>
		public LabTempResultadoEncabezadoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                LabTempResultadoEncabezado o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the LAB_Temp_ResultadoEncabezado table.
	/// </summary>
	[Serializable]
	public partial class LabTempResultadoEncabezado : ActiveRecord<LabTempResultadoEncabezado>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public LabTempResultadoEncabezado()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public LabTempResultadoEncabezado(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LabTempResultadoEncabezado(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LabTempResultadoEncabezado(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LAB_Temp_ResultadoEncabezado", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("LAB_Temp_ResultadoEncabezado",schema);
			}
		}
		#endregion
