...
{
	/// <summary>
	/// Strongly-typed collection for the AprZScorePesoEstatura class.
	/// </summary>
    [Serializable]
	public partial class AprZScorePesoEstaturaCollection : ActiveList<AprZScorePesoEstatura, AprZScorePesoEstaturaCollection>
	{	   
		public AprZScorePesoEstaturaCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprZScorePesoEstaturaCollection</returns>
		public AprZScorePesoEstaturaCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprZScorePesoEstatura o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_ZScorePesoEstatura table.
	/// </summary>
	[Serializable]
	public partial class AprZScorePesoEstatura : ActiveRecord<AprZScorePesoEstatura>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprZScorePesoEstatura()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprZScorePesoEstatura(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprZScorePesoEstatura(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprZScorePesoEstatura(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePesoEstatura", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_ZScorePesoEstatura",schema);
			}
		}
		#endregion
