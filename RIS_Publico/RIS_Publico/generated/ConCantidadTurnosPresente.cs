...
namespace DalRis{
    ...
    public partial class ConCantidadTurnosPresente : ReadOnlyRecord<ConCantidadTurnosPresente>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosPresentes", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_CantidadTurnosPresentes",schema);
            }
        }
        #endregion
