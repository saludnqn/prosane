...
namespace DalRis{
    /// <summary>
    /// Strongly-typed collection for the ConCantidadSobreTurno class.
    /// </summary>
    [Serializable]
    public partial class ConCantidadSobreTurnoCollection : ReadOnlyList<ConCantidadSobreTurno, ConCantidadSobreTurnoCollection>
    {        
        public ConCantidadSobreTurnoCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the CON_CantidadSobreTurnos view.
    /// </summary>
    [Serializable]
    public partial class ConCantidadSobreTurno : ReadOnlyRecord<ConCantidadSobreTurno>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadSobreTurnos", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_CantidadSobreTurnos",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ConCantidadSobreTurno()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ConCantidadSobreTurno(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ConCantidadSobreTurno(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ConCantidadSobreTurno(string columnName, object columnValue)
        {
            SetSQLProps();
