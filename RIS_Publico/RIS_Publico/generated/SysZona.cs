...
namespace DalRis
{
	...
	public partial class SysZona : ActiveRecord<SysZona>, IActiveRecord
	{
		...
		private DalRis.AutEntidadCollection colAutEntidadRecords;
		public DalRis.AutEntidadCollection AutEntidadRecords()
		{
			if(colAutEntidadRecords == null)
			{
				colAutEntidadRecords = new DalRis.AutEntidadCollection().Where(AutEntidad.Columns.IdZona, IdZona).Load();
				colAutEntidadRecords.ListChanged += new ListChangedEventHandler(colAutEntidadRecords_ListChanged);
			}
			return colAutEntidadRecords;
		}
				
		void colAutEntidadRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
            if (e.ListChangedType == ListChangedType.ItemAdded)
            {
		        // Set foreign key value
		        colAutEntidadRecords[e.NewIndex].IdZona = IdZona;
				colAutEntidadRecords.ListChanged += new ListChangedEventHandler(colAutEntidadRecords_ListChanged);
            }
		}
		#endregion
        ...
        public void SetPKValues()
        {
                ...
                if (colAutEntidadRecords != null)
                {
                    foreach (DalRis.AutEntidad item in colAutEntidadRecords)
                    {
                        if (item.IdZona != IdZona)
                        {
                            item.IdZona = IdZona;
