...
{
	/// <summary>
	/// Strongly-typed collection for the LabTempResultadoDetalle class.
	/// </summary>
    [Serializable]
	public partial class LabTempResultadoDetalleCollection : ActiveList<LabTempResultadoDetalle, LabTempResultadoDetalleCollection>
	{	   
		public LabTempResultadoDetalleCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LabTempResultadoDetalleCollection</returns>
		public LabTempResultadoDetalleCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                LabTempResultadoDetalle o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the LAB_Temp_ResultadoDetalle table.
	/// </summary>
	[Serializable]
	public partial class LabTempResultadoDetalle : ActiveRecord<LabTempResultadoDetalle>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public LabTempResultadoDetalle()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public LabTempResultadoDetalle(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LabTempResultadoDetalle(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LabTempResultadoDetalle(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LAB_Temp_ResultadoDetalle", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("LAB_Temp_ResultadoDetalle",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varIdProtocolo,int varIdEfector,int varIdDetalleProtocolo,string varCodigoNomenclador,string varCodigo,int varOrdenArea,int varOrden,string varArea,string varGrupo,string varItem,string varObservaciones,string varEsTitulo,string varDerivado,string varUnidad,bool? varHiv,string varMetodo,string varValorReferencia,int varOrden1,string varMuestra,int varConresultado,string varResultado,string varCodigo2,string varProfesionalVal)
		{
		...
		/// </summary>
		public static void Update(int varIdProtocolo,int varIdEfector,int varIdDetalleProtocolo,string varCodigoNomenclador,string varCodigo,int varOrdenArea,int varOrden,string varArea,string varGrupo,string varItem,string varObservaciones,string varEsTitulo,string varDerivado,string varUnidad,bool? varHiv,string varMetodo,string varValorReferencia,int varOrden1,string varMuestra,int varConresultado,string varResultado,string varCodigo2,string varProfesionalVal)
		{
			LabTempResultadoDetalle item = new LabTempResultadoDetalle();
