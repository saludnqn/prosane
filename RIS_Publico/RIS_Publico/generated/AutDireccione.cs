...
{
	/// <summary>
	/// Strongly-typed collection for the AutDireccione class.
	/// </summary>
    [Serializable]
	public partial class AutDireccioneCollection : ActiveList<AutDireccione, AutDireccioneCollection>
	{	   
		public AutDireccioneCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AutDireccioneCollection</returns>
		public AutDireccioneCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AutDireccione o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AUT_Direcciones table.
	/// </summary>
	[Serializable]
	public partial class AutDireccione : ActiveRecord<AutDireccione>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AutDireccione()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AutDireccione(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AutDireccione(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AutDireccione(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AUT_Direcciones", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("AUT_Direcciones",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(decimal varIdDireccion,string varNombre,string varResponsable,string varTelefono,string varEmail)
		{
