...
{
	/// <summary>
	/// Strongly-typed collection for the AprPercentilesPerimetroCefalicoEdad class.
	/// </summary>
    [Serializable]
	public partial class AprPercentilesPerimetroCefalicoEdadCollection : ActiveList<AprPercentilesPerimetroCefalicoEdad, AprPercentilesPerimetroCefalicoEdadCollection>
	{	   
		public AprPercentilesPerimetroCefalicoEdadCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AprPercentilesPerimetroCefalicoEdadCollection</returns>
		public AprPercentilesPerimetroCefalicoEdadCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AprPercentilesPerimetroCefalicoEdad o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the APR_PercentilesPerimetroCefalicoEdad table.
	/// </summary>
	[Serializable]
	public partial class AprPercentilesPerimetroCefalicoEdad : ActiveRecord<AprPercentilesPerimetroCefalicoEdad>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AprPercentilesPerimetroCefalicoEdad()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AprPercentilesPerimetroCefalicoEdad(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AprPercentilesPerimetroCefalicoEdad(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AprPercentilesPerimetroCefalicoEdad(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesPerimetroCefalicoEdad", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("APR_PercentilesPerimetroCefalicoEdad",schema);
			}
		}
		#endregion
