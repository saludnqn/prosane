...
namespace DalRis{
    /// <summary>
    /// Strongly-typed collection for the ConTurnosAnticipadosAusente class.
    /// </summary>
    [Serializable]
    public partial class ConTurnosAnticipadosAusenteCollection : ReadOnlyList<ConTurnosAnticipadosAusente, ConTurnosAnticipadosAusenteCollection>
    {        
        public ConTurnosAnticipadosAusenteCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the CON_TurnosAnticipadosAusentes view.
    /// </summary>
    [Serializable]
    public partial class ConTurnosAnticipadosAusente : ReadOnlyRecord<ConTurnosAnticipadosAusente>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_TurnosAnticipadosAusentes", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_TurnosAnticipadosAusentes",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ConTurnosAnticipadosAusente()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ConTurnosAnticipadosAusente(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ConTurnosAnticipadosAusente(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ConTurnosAnticipadosAusente(string columnName, object columnValue)
        {
            SetSQLProps();
