...
namespace DalRis
{
	...
	public partial class InsTipoProveedor : ActiveRecord<InsTipoProveedor>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("INS_TipoProveedor", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("INS_TipoProveedor",schema);
			}
		}
		#endregion
