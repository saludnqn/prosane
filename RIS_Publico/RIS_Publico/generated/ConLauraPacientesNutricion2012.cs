...
namespace DalRis{
    ...
    public partial class ConLauraPacientesNutricion2012 : ReadOnlyRecord<ConLauraPacientesNutricion2012>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_laura_pacientesNutricion2012", TableType.View, DataService.GetInstance("RisProvider"));
                ...
                DataService.Providers["RisProvider"].AddSchema("CON_laura_pacientesNutricion2012",schema);
            }
        }
        #endregion
