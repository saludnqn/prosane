...
{
	/// <summary>
	/// Strongly-typed collection for the SysLocalidadBkp class.
	/// </summary>
    [Serializable]
	public partial class SysLocalidadBkpCollection : ActiveList<SysLocalidadBkp, SysLocalidadBkpCollection>
	{	   
		public SysLocalidadBkpCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SysLocalidadBkpCollection</returns>
		public SysLocalidadBkpCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SysLocalidadBkp o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Sys_Localidad_BKP table.
	/// </summary>
	[Serializable]
	public partial class SysLocalidadBkp : ActiveRecord<SysLocalidadBkp>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public SysLocalidadBkp()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public SysLocalidadBkp(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SysLocalidadBkp(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SysLocalidadBkp(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Localidad_BKP", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				colvarIdDepartamento.IsReadOnly = false;
					...
					colvarIdDepartamento.ForeignKeyTableName = "Sys_Departamento_BKP";
				...
				DataService.Providers["RisProvider"].AddSchema("Sys_Localidad_BKP",schema);
			}
		}
		#endregion
		...
		private DalRis.SysZonaCollection colSysZonaRecords;
		public DalRis.SysZonaCollection SysZonaRecords
		{
			get
			{
				if(colSysZonaRecords == null)
				{
					colSysZonaRecords = new DalRis.SysZonaCollection().Where(SysZona.Columns.IdLocalidad, IdLocalidad).Load();
		...
		private DalRis.SysBarrioBkpCollection colSysBarrioBkpRecords;
		public DalRis.SysBarrioBkpCollection SysBarrioBkpRecords
		{
			get
			{
				if(colSysBarrioBkpRecords == null)
				{
					colSysBarrioBkpRecords = new DalRis.SysBarrioBkpCollection().Where(SysBarrioBkp.Columns.IdLocalidad, IdLocalidad).Load();
					colSysBarrioBkpRecords.ListChanged += new ListChangedEventHandler(colSysBarrioBkpRecords_ListChanged);
				}
				return colSysBarrioBkpRecords;			
			}
			set 
			{ 
					colSysBarrioBkpRecords = value; 
					colSysBarrioBkpRecords.ListChanged += new ListChangedEventHandler(colSysBarrioBkpRecords_ListChanged);
			}
		}
		
		void colSysBarrioBkpRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    if (e.ListChangedType == ListChangedType.ItemAdded)
		    {
		        // Set foreign key value
		        colSysBarrioBkpRecords[e.NewIndex].IdLocalidad = IdLocalidad;
		    }
		}
		...
		/// <summary>
		/// Returns a SysDepartamentoBkp ActiveRecord object related to this SysLocalidadBkp
		/// 
		/// </summary>
		public DalRis.SysDepartamentoBkp SysDepartamentoBkp
		{
			get { return DalRis.SysDepartamentoBkp.FetchByID(this.IdDepartamento); }
        ...
        public void SetPKValues()
        {
                if (colSysZonaRecords != null)
                {
                    foreach (DalRis.SysZona item in colSysZonaRecords)
                    {
                ...
                if (colSysBarrioBkpRecords != null)
                {
                    foreach (DalRis.SysBarrioBkp item in colSysBarrioBkpRecords)
                    {
