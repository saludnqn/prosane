...
namespace DalRis
{
	...
	public partial class SysProfesional : ActiveRecord<SysProfesional>, IActiveRecord
	{
		...
		public DalRis.PsmDatoCollection PsmDatosFromSysProfesional
		{
			...
			set 
			{ 
					colPsmDatosFromSysProfesional = value; 
					colPsmDatosFromSysProfesional.ListChanged += new ListChangedEventHandler(colPsmDatosFromSysProfesional_ListChanged);
			}
		}
		...
		public DalRis.SysDefuncionCollection SysDefuncionRecords
		{
			get
			{
				...
				{
					colSysDefuncionRecords = new DalRis.SysDefuncionCollection().Where(SysDefuncion.Columns.IdProfesional, IdProfesional).Load();
		...
		void colSysDefuncionRecords_ListChanged(object sender, ListChangedEventArgs e)
		{
		    ...
		    {
		        // Set foreign key value
		        colSysDefuncionRecords[e.NewIndex].IdProfesional = IdProfesional;
		    }
		}
        ...
        public void SetPKValues()
        {
                if (colPsmDatos != null)
                {
                    ...
                    {
                        if (item.IdProfesionalFicha == null ||item.IdProfesionalFicha != IdProfesional)
                        {
                ...
                if (colPsmDatosFromSysProfesional != null)
                {
                    ...
                    {
                        if (item.IdProfesionalOdonto == null ||item.IdProfesionalOdonto != IdProfesional)
                        {
