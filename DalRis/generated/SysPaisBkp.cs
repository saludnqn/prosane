...
{
	/// <summary>
	/// Strongly-typed collection for the SysPaisBkp class.
	/// </summary>
    [Serializable]
	public partial class SysPaisBkpCollection : ActiveList<SysPaisBkp, SysPaisBkpCollection>
	{	   
		public SysPaisBkpCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SysPaisBkpCollection</returns>
		public SysPaisBkpCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Sys_Pais_BKP table.
	/// </summary>
	[Serializable]
	public partial class SysPaisBkp : ActiveRecord<SysPaisBkp>, IActiveRecord
	{
		...
		public SysPaisBkp(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SysPaisBkp(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SysPaisBkp(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Pais_BKP", TableType.Table, DataService.GetInstance("RisProvider"));
				...
				DataService.Providers["RisProvider"].AddSchema("Sys_Pais_BKP",schema);
			}
		}
		#endregion
		...
		private DalRis.SysProvinciumCollection colSysProvincia;
		public DalRis.SysProvinciumCollection SysProvincia
		{
			get
			{
				if(colSysProvincia == null)
				{
					colSysProvincia = new DalRis.SysProvinciumCollection().Where(SysProvincium.Columns.IdPais, IdPais).Load();
        ...
        public void SetPKValues()
        {
                ...
                if (colSysProvincia != null)
                {
                    foreach (DalRis.SysProvincium item in colSysProvincia)
                    {
                        if (item.IdPais != IdPais)
                        {
                            item.IdPais = IdPais;
